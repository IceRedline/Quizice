...
private final class BackendTestURLProtocol: URLProtocol {
...
private final class BackendMetricSpy: BackendRequestMetricRecording {
    private(set) var values: [BackendRequestMetric] = []
    func record(_ metric: BackendRequestMetric) { values.append(metric) }
}

private final class BackendMemorySessionStore: SessionStoring {
...
private final class BackendScriptedSessionStore: SessionStoring {
...
private final class BackendAIQuizAccessStub: AIQuizAccessUpdating {
...
private struct SlowBackendContentAPI: BackendContentAPI {
...
private final class RecordingBackendContentAPI: BackendContentAPI {
