...
Справочник для разработчика и агента. База: `main`, коммит `ddc8f32` (24.09.2026); разделы статистики, прогресса и replay обновлены вместе с исправлениями синхронизации.
...
- **Индикаторы источника:** на Home/onboarding/экране вопросов доступны Debug-подписи источника данных; для XCTest они подавляются.
