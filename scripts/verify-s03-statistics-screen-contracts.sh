...
require_fixed_string "$THEMES_SERVICE" 'pin(button, to: cell.contentView, bottomInset: Layout.lastItemBottomInset)' 'Statistics card must leave bottom spacing inside the final item'
